...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" href="{{ route('razen-teknologi.admin.fitur-layanan.create') }}"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="fitur_layanan_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Aksi</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#fitur_layanan_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-teknologi.admin.fitur-layanan.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('razen-teknologi.admin.fitur-layanan.destroy', ['id' => ":user_id"]) }}";
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#fitur_layanan_table').DataTable().ajax.reload();
                }
            });
        });
    </script>
