...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Fitur Layanan | Detail</h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group position-relative mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$fitur_layanan->layanan->judul_kecil}}" disabled>
                    </div>
                    <div class="form-group position-relative mb-3">
                        <label class="form-label">Judul</label>
                        <input type="text" class="form-control" value="{{$fitur_layanan->judul}}" disabled>
                    </div>
                </div>
            </div>
        </div>
