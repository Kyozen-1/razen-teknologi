...
@section('title', 'Razen Teknologi | Profil')
...
@section('content')
        ...
        <div class="col-12 col-md-7">
            ...
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-teknologi.admin.profil.index') }}">Profil</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('razen-teknologi.admin.profil.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
    ...
    <script>
        ...
        $('#edit_media_sosial_profil_form').submit(function(e){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-teknologi.admin.profil.edit-media-sosial-profil') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            ...
                            if(data.success)
                            {
                                new swal({
                                    ...
                                    title: data.success
                                        ...
                                        window.location.href = "{{ route('razen-teknologi.admin.profil.index') }}";
                                });
                            }
                        }
                    });
        ...
        $('#tambah_media_sosial_profil_form').submit(function(e){
            e.preventDefault();
            $.ajax({
                url: "{{ route('razen-teknologi.admin.profil.tambah-media-sosial-profil') }}",
                method: "POST",
