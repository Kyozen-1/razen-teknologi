...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" href="{{ route('razen-teknologi.admin.layanan.create') }}"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#layanan_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-teknologi.admin.layanan.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('razen-teknologi.admin.layanan.destroy', ['id' => ":user_id"]) }}";
