...
<script>
    const settings = new Settings({
        @if (Auth::guard('razen_teknologi')->check())
            attributes: {
                color: "{{Auth::guard('razen_teknologi')->user()->color_layout?Auth::guard('razen_teknologi')->user()->color_layout:'light-blue'}}",
                navcolor: "{{Auth::guard('razen_teknologi')->user()->nav_color?Auth::guard('razen_teknologi')->user()->nav_color:'light'}}",
                behaviour: "{{Auth::guard('razen_teknologi')->user()->behaviour?Auth::guard('razen_teknologi')->user()->behaviour:'pinned'}}",
                layout: "{{Auth::guard('razen_teknologi')->user()->layout?Auth::guard('razen_teknologi')->user()->layout:'fluid'}}",
                radius: "{{Auth::guard('razen_teknologi')->user()->radius?Auth::guard('razen_teknologi')->user()->radius:'flat'}}",
                placement: "{{Auth::guard('razen_teknologi')->user()->placement?Auth::guard('razen_teknologi')->user()->placement:'vertical'}}",
            }
        @endif
    });
    $('.option').click(function(){
        ...
        $.ajax({
            url: "{{ route('razen-teknologi.admin.dashboard.change') }}",
            method: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
