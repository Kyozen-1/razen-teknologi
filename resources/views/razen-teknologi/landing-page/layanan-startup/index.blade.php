...
@section('title', 'Razen Teknologi | Landing Page | Layanan | Startup')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Razen Teknologi | Landing Page | Layanan | Startup</h1>
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_1.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}
            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-1') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12 col-md-7">
                    ...
                    <div class="col-12 col-md-5">
                        <div class="position-relative form-group mb-3">
                            ...
                            @if ($section_1)
                                <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/landing-page/layanan/startup/'.$section_1['gambar']) }}" required>
                            @else
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_2.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-2') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_3.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-3') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                        ...
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Deskripsi</label>
                            <textarea name="deskripsi" rows="5" class="form-control" required>{{$section_3?$section_3['deskripsi'] : ''}}</textarea>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary mb-0">Submit</button>
            ...
            @if ($section_3)
                @if ($section_3['konten'] == '')
                    <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-3.konten') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-6">
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_4.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-4') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_5.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-5') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_6.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-6') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12 col-md-7">
                        <div class="mb-3 position-relative form-group">
                    ...
                    <div class="col-12 col-md-5">
                        <div class="position-relative form-group mb-3">
                            <label for="" class="form-label">Gambar</label>
                            @if ($section_6)
                                <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/landing-page/layanan/startup/'.$section_6['gambar']) }}" required>
                            @else
                                <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" required>
                            @endif
                        </div>
            ...
            @if ($section_6)
                @if ($section_6['konten'] == '')
                    <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-6.konten') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-6">
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/layanan/startup/section_7.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-teknologi.landing-page.layanan.startup.store.section-7') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
    ...
    <script>
        ...
        $('.btn_hapus_gambar_section_3').click(function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-teknologi.landing-page.layanan.startup.hapus.section-3.konten') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id:id
                        ...
                        success: function(data)
                        {
                            new swal({
                                ...
                                title: data.success
                                    ...
                                    window.location.href = "{{ route('razen-teknologi.landing-page.layanan.startup.index') }}";
                            });
                        }
                    });
                }
        ...
        function dynamic_section_6(number)
        {
            ...
            html = '<div class="border shadow p-3 mb-3">'
                ...
                html += '<div class="position-relative mb-3 form-group row">';
                    html += '<label class="col-md-3 col-form-label">Judul</label>';
                    html += '<div class="col-md-9">';
                        html += '<textarea name="section_6['+urut+'][judul]" rows="5" class="form-control" required></textarea>';
                    html += '</div>';
                html += '</div>';
            html += '</div>';
            if(number >= 1)
        ...
        $('.btn_hapus_gambar_section_6').click(function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-teknologi.landing-page.layanan.startup.hapus.section-6.konten') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id:id
