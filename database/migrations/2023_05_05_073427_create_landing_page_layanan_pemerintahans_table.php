...
class CreateLandingPageLayananPemerintahansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landing_page_layanan_pemerintahans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landing_page_layanan_pemerintahans');
    }
}
