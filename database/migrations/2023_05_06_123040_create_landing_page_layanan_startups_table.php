...
class CreateLandingPageLayananStartupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landing_page_layanan_startups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landing_page_layanan_startups');
    }
}
