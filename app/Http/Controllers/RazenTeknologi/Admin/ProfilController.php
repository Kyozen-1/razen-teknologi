...
class ProfilController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('razen-teknologi.admin.profil.index', [
    ...
    public function store(Request $request)
    {
        ...
        if($request->logo)
        {
            File::delete(public_path('images/razen-teknologi/logo/'.$profil->logo));

            $logoExtension = $request->logo->extension();
            $logoName =  uniqid().'-'.date("ymd").'.'.$logoExtension;
            $logo = Image::make($request->logo);
            $logoSize = public_path('images/razen-teknologi/logo/'.$logoName);
        ...
        return redirect()->route('razen-teknologi.admin.profil.index');
    }
