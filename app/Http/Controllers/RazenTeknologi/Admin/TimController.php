...
class TimController extends Controller
{
        ...
        if(request()->ajax())
        {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('aksi', function($data){
                    $button_show = '<a href="'.route('razen-teknologi.admin.tim.show', ['id' => $data->id]).'" class="detail btn btn-icon waves-effect btn-info" title="Detail Data"><i class="fas fa-eye"></i></a>';
                    $button_edit = '<a href="'.route('razen-teknologi.admin.tim.edit', ['id' => $data->id]).'" class="edit btn btn-icon waves-effect btn-warning" title="Edit Data"><i class="fas fa-edit"></i></a>';
                ...
                ->editColumn('foto', function($data){
                    return '<img src="'.asset('images/razen-teknologi/tim/'.$data->foto).'" style="height:5rem;">';
                })
                ->rawColumns(['aksi', 'foto', 'media_sosial'])
                ->make(true);
        }
        return view('razen-teknologi.admin.tim.index');
    }
    ...
    public function create()
    {
        ...
        return view('razen-teknologi.admin.tim.create', [
    ...
    public function store(Request $request)
    {
        ...
        $fotoSize = public_path('images/razen-teknologi/tim/'.$fotoName);
        ...
        return redirect()->route('razen-teknologi.admin.tim.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('razen-teknologi.admin.tim.detail', [
            'tim' => $tim,
            'pivot' => $pivot
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('razen-teknologi.admin.tim.edit', [
            'tim' => $tim,
            'pivot' => $pivot,
            'media_sosial' => $media_sosial,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            $timFoto = $tim->foto;
            File::delete(public_path('images/razen-teknologi/tim/'.$timFoto));
    ...
    public function destroy($id)
    {
        ...
        File::delete(public_path('images/razen-teknologi/tim/'.$razenProjectSectionTim));
